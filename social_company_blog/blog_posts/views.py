...
from social_company_blog.models import BlogPost
from social_company_blog.blog_posts import BlogPostForm
...
def delete_post(blog_post_id):
    ...
    ## no template, just an action using a button and bootstrap
